...
Usage:
    ...
    python -m scripts.train_forecasting

    # Custom train/test
    python -m scripts.train_forecasting --train 20242025 --test 20252026

    # Train only, skip evaluation
    python -m scripts.train_forecasting --train 20242025 --no-eval
"""
